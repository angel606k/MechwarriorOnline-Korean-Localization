...
1. Git의 [Build 폴더](https://github.com/angel606k/MechwarriorOnline-Korean-Localization/tree/master/Build)에 있는 최신버전의 한글패치를 다운로드 합니다.<br>
(다운로드 방법: 위 링크에 접근 후 최신버전 파일을 클릭 후 우측의 Download 버튼을 클릭)
